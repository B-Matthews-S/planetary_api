...
def register():
    ...
    return UserController.register(email)
...
def planet_details():
    ...
    return PlanetController.planet_details(planet_id)
...
def update_planet():
    ...
    radius = float(request.form['radius'])
    distance = float(request.form['distance'])
    return PlanetController.update_planet(planet_name, planet_type, home_star, mass, radius, distance)
